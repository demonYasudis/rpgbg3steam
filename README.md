...
3. Победите всех противников. Ходы продолжаются: верните любого живого героя на `EXIT`
   у стартовой позиции Warrior и нажмите `Extract party`. Это эвакуирует всех выживших.
4. Экран результата покажет золото, предметы, HP и погибших. При поражении добыча теряется.

Предметы пока представлены данными награды: экипировка, применение расходников и
хранилище гильдии ещё не реализованы. Результат хранится только в текущей сессии Play.
